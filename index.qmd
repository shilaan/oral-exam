...
- Qualitative statements pretested using the **Certainty Lexicon** and human participants
...
- Three-round **incentivized** game ($0.50 per correct answer) 
...
The focal manager “is a good leader”, “has strong leadership skills”, and “has the ability to lead other people”
    </details>
- Warmth<details>
    <summary>
    Show items
    </summary>
The focal manager is “friendly”, “well-intentioned”, “trustworthy”, “warm”, “good-natured”, and “sincere”
    </details>
- Competence<details>
    <summary>
    Show items
    </summary>
The focal manager is “competent”, “capable”, “independent”, “intelligent”, and “skillful”
    </details>
...
At the end of three rounds, participants move on to a new incentivized game and are asked whether they would like to keep the same team leader or be paired with a new team leader (whose performance is similar). We obtain a single dichotomous measure indicating whether participants choose to keep the same leader (leader selection: 0 = no, 1 = yes)
    </details>
...
- Assess linear effects of leader-expressed uncertainty (separately for each outcome)<details>
  ...
  - Evidence for **H1**: Pooled estimate significant and negative 
  - Evidence for **H2**: Pooled estimate significant and positive 
  :::
    </details>
- Assess nonlinear effects of leader-expressed uncertainty (separately for each outcome)<details>
  ...
  - Random-effects **meta-analysis** to obtain pooled effect size estimate
  - Evidence for **H3**
    - Pooled estimate of **1st line positive** and significant; **and**
    - Pooled estimate of **2nd line negative** and significant
  :::
    </details>
