...
## Ambition ➙ Leader Effectiveness?{background-image="images/self-aware.png" background-size="530px" background-position="90% 30%"}
...
## Uncorroborated Positive Self-Views{style='font-size: 24px'}
...
![](images/model.png){.absolute right="350" bottom="40" height="440"}
...
Self-views of leader effectiveness have a **positive relationship** with ambition

- $\beta_1$ = 0.28, 95% CI [0.14, 0.42], *z* = 3.93, *p* < .001

. . .

Third-party perceptions have **no relationship** with ambition
...
Self-views of leader effectiveness have a **positive relationship** with motivation to lead

- $\beta_1$ = 0.48, 95% CI [0.27, 0.68], *z* = 4.59, *p* < .001

. . .

Third-party perceptions have **no relationship** with motivation to lead
...
## Is Ambition Well-Calibrated? {visibility="uncounted"}
...
- Assess the **time-lagged effect of ambition** on...
  ...
  - Self-rated leader effectiveness (H1)
- **T1 Ambition**<details>
    <summary>
    Show items
    </summary>
...
Relationship between ambition and self-rated leadership effectiveness (**Hypothesis 1**)
