...
**Uncorroborated Positive Self-Views Hypothesis**  
...
- RSA identifies the **Uncorroborated Positive Self-Views Model** as the best fit with the data
...
## Uncorroborated Positive Self-Views Model{style='font-size: 20px'}
...
![](images/model.png){.absolute right="350" bottom="40" height="460"}
...
The **Uncorroborated Positive Self-Views model** provides the best fit with the data
...
- Self-views only: **Uncorroborated Positive Self-Views Model**
